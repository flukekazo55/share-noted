...
export const importedDocuments: Manuscript[] = [
  ...
  },
  {
    ...
    category: "Imported / Text",
    content: "วัตถุประสงค์\nใช้ตรวจเคสที่ OTCSale ค้างและยังไม่รับผลจาก SAP\n\nขั้นตอน\n1. ตรวจ log `LogCreatePayment` ใน OTC LOG (PROD)\n2. filter ด้วย `{OrderNumber: '1VL6435125120010'}`\n3. ตรวจ log `LogCreateSaleOrder` ใน OTC LOG (PROD)\n4. filter ด้วย `{OrderNumber: '1VL6435125120010'}`\n5. เปิด Kafka topic `https://kd.thaibevapp.com/topic/otc-otcsale-sap-interface`\n6. filter เลข `1VL6435125120010`\n7. เปิด Kafka topic `https://kd.thaibevapp.com/topic/otc-otcsale-sap-response`\n8. filter เลข `1VL6435125120010`\n9. ถ้ายังไม่พบข้อมูลจาก `sap-response` ให้ produce message ซ้ำที่ topic `otc-otcsale-sap-interface`\n10. ตรวจผลต่อที่ฝั่ง `OTP` และ `LE`",
    dateCreated: new Date("2026-03-23"),
    status: "Published" as Manuscript['status'],
  ...
  {
    id: 32,
    title: "รันงาน UAT Sync Data เข้า OMSAP 15-08-2025",
    category: "Imported / Text",
  ...
  },
  {
    ...
    category: "Imported / Text",
    content: "วัตถุประสงค์\nใช้ลบ `SAP Error Log` ออกจากรายงาน\n\nตรวจข้อมูลก่อนลบ\n```sql\nSELECT *\nFROM [RPT_Sales_OR].[dbo].[RPT_Sap_Response_Message]\nWHERE DocumentNumber = 'CVT0243025080002';\n```\n\nลบข้อมูล\n```sql\nDELETE\nFROM [RPT_Sales_OR].[dbo].[RPT_Sap_Response_Message]\nWHERE DocumentNumber = 'CVT0243025080002';\n```",
    dateCreated: new Date("2026-03-23"),
    status: "Published" as Manuscript['status'],
  ...
  },
  {
    ...
    category: "Imported / Text",
    content: "วัตถุประสงค์\nใช้ reproduce ใบขาย OTCSale ตามเลขเอกสารที่ต้องการ\n\nตัวอย่างเคส\n- ใบขาย `1VT0257625080045`\n\nขั้นตอน\n1. เปิด Swagger `http://otcsale.thaibevapp.com/otcsellapi/swagger/index.html`\n2. ใส่ `Bearer token`\n3. เรียก API `PurchaseOrder/ReProduce/1VT0257625080045` โดยใช้ `signature: 9901`\n4. กด run\n5. ตรวจไฟล์ export เอกสารค้างขน\n6. filter ตาม `customer code` และ `product`\n7. ตรวจผลรวมของสินค้า",
    dateCreated: new Date("2026-03-23"),
    status: "Published" as Manuscript['status'],
